...
namespace Mojio.Platform.SDK.SimpleClient
{
    public class SimpleClient : IClient
    {
        ...
        public async Task<IPlatformResponse<IAppResponse>> Apps(int skip = 0, int top = 1000, string filter = null,
        ...
        public async Task<IPlatformResponse<IApp>> CreateApp(IApp application,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IList<string>>> SaveTag(TagEntities entityType, Guid entityId, string tag,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IMessageResponse>> DeleteTag(TagEntities entityType, Guid entityId,
            string tag, CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
            return await SdkClient.DeleteTag(entityType, entityId, tag, cancellationToken, progress);
        }

        public async Task<IPlatformResponse<IMessageResponse>> DeleteApp(Guid id,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IApp>> UpdateApp(IApp app, CancellationToken? cancellationToken = null,
            IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IImage>> GetImage(ImageEntities entityType, Guid id,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IActivityStreamApiResponse>> UserActivityStream(
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IMessageResponse>> DeleteImage(ImageEntities entityType, Guid id,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IMessageResponse>> SaveImage(ImageEntities entityType, Guid id, byte[] image,
            string fileName, string contentType, CancellationToken? cancellationToken = null,
            IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IMessageResponse>> GetAppSecret(Guid id,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IMessageResponse>> DeleteAppSecret(Guid id,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IAuthorization>> Login(string username, string password,
            string scope = "full", CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
        ...
        public async Task<IPlatformResponse<IAuthorization>> Login(IAuthorization authorization,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
            ...
            if (_authManager != null && (authorization?.Signature != Authorization?.Signature) &&
                !string.IsNullOrEmpty(authorization?.Signature) && !string.IsNullOrEmpty(Authorization?.Signature))
            {
        ...
        public async Task<IPlatformResponse<IMessageResponse>> Register(string email, string password,
            string username = null, string mobileNumber = null, CancellationToken? cancellationToken = null,
            IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IPushObserverResponse>> DeleteObserver(ObserverEntity entity, string key,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IPushObserverResponse>> GetObserver(ObserverEntity entity, string key,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IList<ITransport>>> GetObserverTransports(ObserverEntity entity, string key,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<TTr>> AddObserverTransport<TTr>(ObserverEntity entity, string observerKey,
            ITransport transport, CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
            where TTr : ITransport
        {
            SetupTokenAndProgress(cancellationToken, progress);
            return
                await SdkClient.AddObserverTransport<TTr>(entity, observerKey, transport, cancellationToken, progress);
        }

        public async Task<IPlatformResponse<TTr>> AddOrUpdateObserverTransport<TTr>(ObserverEntity entity,
            string observerKey, ITransport transport, CancellationToken? cancellationToken = null,
            IProgress<ISDKProgress> progress = null) where TTr : ITransport
        {
            SetupTokenAndProgress(cancellationToken, progress);
            return
                await
                    SdkClient.AddOrUpdateObserverTransport<TTr>(entity, observerKey, transport, cancellationToken,
                        progress);
        }

        public async Task<IPlatformResponse<IPushObserverResponse>> DeleteObserverTransport(ObserverEntity entity,
            string observerKey, string transportKey, CancellationToken? cancellationToken = null,
            IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
            return
                await SdkClient.DeleteObserverTransport(entity, observerKey, transportKey, cancellationToken, progress);
        }
        ...
        public async Task<IPlatformResponse<IPushObserverResponse>> Observe(ObserverEntity entity, Guid? entityId,
            IPushObserver observer, CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
            return await SdkClient.Observe(entity, entityId, observer, cancellationToken, progress);
        }

        public async Task<IPlatformResponse<IPushObserverResponse>> ObserveMojio(Guid mojioId, IPushObserver observer,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IPushObserverResponse>> ObserveUser(Guid userId, IPushObserver observer,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IPushObserverResponse>> ObserveVehicle(Guid vehicleId,
            IPushObserver observer, CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IVehicleLocationResponse>> TripHistoryLocations(string tripId, int skip = 0,
        ...
        public async Task<IPlatformResponse<IVehiclesResponse>> TripHistoryStates(string tripId, int skip = 0,
            int top = 1000, string fields = null, CancellationToken? cancellationToken = null,
            IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<ITrip>> UpdateTripName(string tripId, string name,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<ITrip>> GetTrip(string tripId, CancellationToken? cancellationToken = null,
            IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IMessageResponse>> DeleteTrip(string tripId,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<ITripsResponse>> Trips(int skip = 0, int top = 10, string filter = null,
            string select = null, string orderby = null, CancellationToken? cancellationToken = null,
            IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IMojioResponse>> Mojios(int skip = 0, int top = 1000, string filter = null,
            string select = null, string orderby = null, CancellationToken? cancellationToken = null,
            IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IMessageResponse>> DeleteMojio(Guid id,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IVehicle>> CreateNewVehicle(IVehicle vehicle,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<string>> Simulate(IMachineRequest request,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        private void SetupTokenAndProgress(CancellationToken? cancellationToken = null,
            IProgress<ISDKProgress> progress = null)
        {
        ...
        public async Task<IPlatformResponse<IGroupResponse>> Groups(CancellationToken? cancellationToken = null,
            IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IGroup>> Group(Guid id, CancellationToken? cancellationToken = null,
            IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IList<string>>> GroupUsers(Guid id,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IMessageResponse>> DeleteGroup(Guid id,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IMessageResponse>> UpdateGroup(Guid id, IGroup @group,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IGroup>> CreateGroup(IGroup @group,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IMessageResponse>> RemoveUserFromGroup(Guid id, Guid userId,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
        ...
        public async Task<IPlatformResponse<IList<string>>> AddUserToGroup(Guid id, IList<Guid> users,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null)
        {
            SetupTokenAndProgress(cancellationToken, progress);
            ...
            bool skipCache = false)
        {
            ...
            return
                await
                    SdkClient.UpdateWifiSettings(mojioId, ssid, password, radioStatus, timeToLive, cancellationToken,
                        progress);
        }
        ...
        {
            SetupTokenAndProgress(cancellationToken, progress);
            return await SdkClient.GetWifiSettingsAfterUpdate(mojioId, transactionId, cancellationToken, progress);
        }

        public async Task<IPlatformResponse<ICapabilities>> Capabilities(Guid mojioId,
            CancellationToken? cancellationToken = null, IProgress<ISDKProgress> progress = null,
            bool skipCache = false)
        {
            SetupTokenAndProgress(cancellationToken, progress);
